    ...
    starlight({
      ...
      sidebar: [
        ...
        },
        {
          ...
          items: [
            { label: 'Endpoints', translations: { ko: '엔드포인트' }, link: '/api-reference/' },
          ],
        },
        {
          label: 'Clients',
          ...
          items: [
            { label: 'TypeScript Client', translations: { ko: 'TypeScript 클라이언트' }, link: '/ts-client/' },
            { label: 'Python Client', translations: { ko: 'Python 클라이언트' }, link: '/py-client/' },
          ],
        },
        {
          label: 'Deep Dive',
